			...
			while(1)
			{
				...
				if(extraCheck()!=1)
					...
					goto next;
                        ...
                        mainOuterP:x=(get_random(number1,number2)%50+get_random(number1,number2)%50)%50;
                            i = 0;
                        ...
                        mainOuterQ:y=(get_random(number1,number2)%50+get_random(number1,number2)%50)%50;
